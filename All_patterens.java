...
public static void pascal(int pn){
   
    for(int i = 0; i < pn; i++){ // Outer loop to handle the number of rows
        for(int j = 1; j < (pn - i); j++){ // Loop to handle the number of spaces before numbers in each row
            System.out.print(" "); // Print space
        }
        
        int number = 1; // Initialize the first number in the row as 1
        
        for(int k = 0; k <= i; k++){ // Inner loop to handle the numbers in each row
